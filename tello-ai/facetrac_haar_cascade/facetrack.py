...
w,h = 360,240
pid = [0.5,0.5,0]#change these values to make the movement smoother

#safe distance
safe_distance = [6200,6800] #smaller values mean drone is closer about 2metres equivalent
...
while True:
    ...
    #control drone with keyboard, set to true to enable keyboard control
    vals = kbc.action(keyboard_control)
    tello.send_rc_control(vals[0],vals[1],vals[2],vals[3])
    time.sleep(0.05)
    #print("lr,fb,ud,yv commands from keyboard: ",vals)
    #control drone with ble devices i.e phones and watches
